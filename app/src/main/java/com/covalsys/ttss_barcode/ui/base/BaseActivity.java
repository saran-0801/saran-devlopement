...
import com.covalsys.ttss_barcode.utils.CommonUtils;
...
public abstract class BaseActivity<V extends ViewModel,D extends ViewDataBinding> extends AppCompatActivity
    ...
    public static final String MyPREFERENCES = "ttss_temp" ;
...
*/
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mCurrentTheme = mSpref.getString(KEY_CURRENT_THEME,BLUE_THEME);
    ...
    protected void onResume() {
        super.onResume();
        String mSelectedTheme = mSpref.getString(KEY_CURRENT_THEME,BLUE_THEME);
