package com.covalsys.ttss_barcode;
...
import com.covalsys.ttss_barcode.di.component.DaggerAppComponent;
...
public class MyApplication extends Application implements HasActivityInjector  {
    ...
    private void initializeCalligraphy() {
        ViewPump.init(ViewPump.builder().addInterceptor(new CalligraphyInterceptor(new CalligraphyConfig.Builder()
                .setDefaultFontPath("fonts/poppins_regular.ttf")   //SourceSansPro-Regular
