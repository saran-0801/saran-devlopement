...
public class AssetCountLine {
    ...
    public AssetCountLine(Integer docEntry, Integer docNum, String batchNo, Float sysQty, Float actQty, String itemCode, String itemName, String remarks, String scanDate, String status) {
